    ...
    <div>
      ...
      <div className="hidden md:block">
        ...
        <section className="lg:flex items-center mb-10 gap-6 mx-20">
          ...
          <div className="w-full">
            ...
            <h5>
              ...
              with men. If you don&apos;t like your match, just click
              &ldquo;Next&rdquo; to be connected with a new stranger in a
              second. Meeting new friends from all over the world has never been
              easier.
            </h5>
          </div>
        </section>
        <section className="lg:flex items-center mb-10 gap-6 mx-20">
          <div className="w-full">
            ...
            <h5>
              ...
              your partner&apos;s language. You won&apos;t even realize that
              your partner is on the other side of the world.
            </h5>
          </div>
          <div className="w-full">
            <Image
        ...
        <section className="text-center mb-10">
          ...
          <h6 className="mb-10">
            Select your gender, click &ldquo;start searching&rdquo;...
            That&apos;s it! You&apos;re in a private live
